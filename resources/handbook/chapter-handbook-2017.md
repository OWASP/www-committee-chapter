...
title: Chapter Handbook (draft WIP)
layout: col-document
...
Draft note: This old Chapter Handbook from 2017 is severely in need of an update, and is considered in draft form and informative at best. If you can, please assist the Chapter Committee with an update to remove policy statements (because they don't belong here) and improve guidance for new and existing leaders. As it stands, this handbook must be considered draft as it is so out of date and so out of synchronization with current Chapter Policy, Foundation procedures, and practices. The Chapter Handbook has **never** had any policy precedence, and should be considered as guidance. Any policy statements - outdated or not - in this handbook are superceded by the current [Chapters Policy](https://owasp.org/www-policy/operational/chapters) and must be removed or replaced with how best Chapter leaders should adhere to the policy. If in any doubt, the Chapter Policy has precedence and any procedures or guidance should be aligned with policy and not this draft. Once this Handbook has been updated, the Chapter Committee will remove this statement for another that will also indicate that the Chapter Handbook is a set of best practices and guidance for Chapter leaders, and not policy.
